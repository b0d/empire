...
export async function generateMetadata({ params }) {
	const locale = params?.locale || "ru"; // Fallback to 'ru' if locale is undefined
	try {
		const translations = await import(`../../../../../messages/${locale}.json`);
		const t = translations.default.Blog15;
...
export default function Blog15({ params: { locale } }) {
	unstable_setRequestLocale(locale);
	const t = useTranslations("Blog15");
