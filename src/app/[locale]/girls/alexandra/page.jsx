...
export async function generateMetadata({ params }) {
	...
	return {
		title: t.lady[2].title,
		description: t.lady[2].description,
	};
}
...
export default function Alexandra({ params: { locale } }) {
		...
		<section>
			...
			<div className='x'>
				<div className='h2-title'>
					<h1>
						{z("Ladies.beforeModelName")} {z("Ladies.lady.2.name")}
					</h1>
				</div>
				...
				<div className='d-flex justify-content-center'>
					<ClientPopup
						id={z("Ladies.lady.2.id")}
						name={z(`Ladies.lady.2.name`)}
					/>
				</div>
				<div className='container d-flex flex-row flex-wrap girls-block'>
					<div className='col-12 col-sm-6'>
						<Image
							src={z("Ladies.lady.2.img.2")}
							alt={z("Ladies.lady.2.alt")}
							width={850}
							height={1250}
						/>
